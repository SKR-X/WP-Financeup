<?php 
  ...
  $slider_post_four = array(get_theme_mod('slider_post_four'));
  $slider_post_five = array(get_theme_mod('slider_post_five'));
...
<section class="ta-slider-warraper">
  <div id="ta-slider" class="owl-carousel">
   ...
   <figure>
	...
	if($slider_post_four){ ?>
	<?php
			$slider_query = new WP_Query( array( 'post__in' => $slider_post_four, 'ignore_sticky_posts' => true));
            if( $slider_query->have_posts() ){                
                while( $slider_query->have_posts() ){
                    $slider_query->the_post();		
     ?>
   ...
   <figure>
	...
	if($slider_post_five){ ?>
	<?php
			$slider_query = new WP_Query( array( 'post__in' => $slider_post_five, 'ignore_sticky_posts' => true));
            if( $slider_query->have_posts() ){                
                while( $slider_query->have_posts() ){
                    $slider_query->the_post();		
     ?>
